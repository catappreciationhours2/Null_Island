...
<style>
  /* ─────────────────────────────────────────────────────────
     CORE LAYOUT STYLES (PRESERVING YOUR OLD BASES)
     ───────────────────────────────────────────────────────── */
  .topbar { 
  ...
  /* Retro Theme Extension Override */
  .topbar.retro { 
    border-bottom:2px solid #ffee00; 
    box-shadow:0 2px 12px rgba(255, 238, 0, 0.13); 
  }
  ...
  /* Pac-Man Character Sprite Style Animation */
  .pac {
  ...
  /* Stats and Clustering Right-Sided Panel Elements */
  ...
  :global([data-theme="retro"]) .stat { font-size:10px; letter-spacing:1px; color:var(--text2); }
  :global([data-theme="retro"]) .stat.gold { color:#ffbb00; text-shadow:0 0 5px rgba(255, 187, 0, 0.4); }

  /* UI Interactive Toggle Switches Buttons Elements */
  .toggle-btn {
  ...
  :global([data-theme="retro"]) .toggle-btn:hover { border-color:#ffee00; color:#ffee00; box-shadow:0 0 6px rgba(255, 238, 0, 0.4); }
</style>